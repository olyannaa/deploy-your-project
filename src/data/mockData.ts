...
export const mockTasks = [
  ...
  // Бухгалтерские задачи без привязки к проекту
  { id: "acc-1", title: "Оплата аренды офиса за март", status: "done", taskType: "accounting", accountingSubtype: "extra_costs", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-03-25", plannedEndDate: "2024-03-31", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: [] },
  { id: "acc-4", title: "Оплата хостинга и ПО", status: "new", taskType: "accounting", accountingSubtype: "other", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-15", plannedEndDate: "2024-04-20", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: [] },
  { id: "acc-7", title: "Оплата канцтоваров и расходных материалов", status: "new", taskType: "accounting", accountingSubtype: "extra_costs", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-25", plannedEndDate: "2024-04-30", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: [] },
  // Субподрядчики — привязаны к проектам
  ...
  { id: "acc-8", title: "Оформление КС-2/КС-3 — «Парковый»", status: "new", taskType: "accounting", accountingSubtype: "subcontract", projectId: "proj-2", projectName: "Жилой комплекс «Парковый»", assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-05-01", plannedEndDate: "2024-05-20", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: ["psub-3"] },
  // Доп. затраты — привязаны к проектам
