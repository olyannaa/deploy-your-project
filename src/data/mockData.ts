...
export const mockTasks = [
  ...
  // Зарплатные задачи — без привязки к проекту (salary не может быть привязана к проекту)
  { id: "acc-1", title: "Выплата ЗП за март", status: "done", taskType: "accounting", accountingSubtype: "salary", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-03-25", plannedEndDate: "2024-03-31", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: ["user-1", "user-2", "user-3", "user-4"] },
  { id: "acc-4", title: "Выплата аванса за апрель", status: "new", taskType: "accounting", accountingSubtype: "salary", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-15", plannedEndDate: "2024-04-20", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: ["user-2", "user-3", "user-6"] },
  { id: "acc-7", title: "Выплата ЗП (общая) за май", status: "new", taskType: "accounting", accountingSubtype: "salary", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-25", plannedEndDate: "2024-04-30", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: ["user-1", "user-2", "user-3", "user-4", "user-6", "user-7", "user-8"] },
