...
export const mockTasks = [
  ...
  { id: "task-7", title: "Проверка актов выполненных работ", status: "in_progress", taskType: "accounting", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-01", plannedEndDate: "2024-04-15", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
  ...
  { id: "task-11", title: "Оформление КС-2, КС-3", status: "new", taskType: "accounting", projectId: "proj-4", projectName: "Школа на 550 мест", assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-10", plannedEndDate: "2024-04-25", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
