...
export const mockTasks = [
  ...
  { id: "acc-1", title: "Списание на хоз. нужды — март", status: "done", taskType: "accounting", accountingSubtype: "additional", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-03-25", plannedEndDate: "2024-03-31", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: [] },
  { id: "acc-4", title: "Доп. затраты вне проекта — апрель", status: "new", taskType: "accounting", accountingSubtype: "additional", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-15", plannedEndDate: "2024-04-20", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: [] },
  { id: "acc-7", title: "Хоз. расходы — май", status: "new", taskType: "accounting", accountingSubtype: "other", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-25", plannedEndDate: "2024-04-30", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null, selectedEmployeeIds: [] },
