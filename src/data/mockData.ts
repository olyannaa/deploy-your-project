...
export const mockTasks = [
  ...
  { id: "task-4", title: "Выставление счёта за проектные работы", status: "review", taskType: "accounting", projectId: "proj-1", projectName: "Агропромышленный комплекс «Рассвет»", assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-01", plannedEndDate: "2024-04-20", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
  ...
  { id: "task-7", title: "Выплата субподрядчику за монтаж", status: "in_progress", taskType: "accounting", projectId: "proj-1", projectName: "Агропромышленный комплекс «Рассвет»", assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-01", plannedEndDate: "2024-04-15", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
  ...
  { id: "task-11", title: "Выплата ЗП по проекту «Школа»", status: "new", taskType: "accounting", projectId: "proj-4", projectName: "Школа на 550 мест", assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-10", plannedEndDate: "2024-04-25", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
  { id: "task-13", title: "Оформление КС-2, КС-3", status: "in_progress", taskType: "accounting", projectId: "proj-2", projectName: "Жилой комплекс «Парковый»", assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-05-01", plannedEndDate: "2024-05-20", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
  { id: "task-14", title: "Контроль дебиторской задолженности", status: "new", taskType: "accounting", projectId: null, projectName: null, assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-04-15", plannedEndDate: "2024-04-30", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
  { id: "task-15", title: "Сверка оплат с заказчиком", status: "done", taskType: "accounting", projectId: "proj-4", projectName: "Школа на 550 мест", assigneeId: "user-5", assigneeName: "Морозова Елена Андреевна", plannedStartDate: "2024-03-01", plannedEndDate: "2024-03-15", approvalStatus: null, assigneeContractorName: null, assigneeIsAccountant: true, sectionId: null },
